...
//           第一个参数：流程定义的key
//           第二个参数：businessKey，存出差申请单的id，就是1001，存json字符串都可以，无所谓,注意数据库的长度限制是255
        ProcessInstance instance = runtimeService.
                startProcessInstanceByKey("new-Leave", "1001");
//        4、输出
...
//        3、查询流程定义,获取流程定义的查询对象
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery()
                .processDefinitionKey("new-Leave")
                .singleResult();
